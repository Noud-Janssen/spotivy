...
void debug_client::init()
{
    ...
    define("help",
           ...
           {   
               ...
               std::cout << " ─ pause                          pause the current playing song" << std::endl << std::endl;
    ...
    define("playlist",
           [&](std::vector<std::string> strings)
           {
               if (strings.size() == 1)
               {
                   std::cout << "playlist add [artist index] [album index] [song index] to [playlist index]"
                             << std::endl;
                   std::cout << "playlist add [artist index] [album index] to [playlist index]" << std::endl;
                   std::cout << "playlist remove [artist index] [album index] [song index] from [playlist] -- remove a "
                                "song in a playlist"
                             << std::endl;
